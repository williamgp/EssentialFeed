...
final class FeedViewControllerTests: XCTestCase {
    ...
    func test_feedView_HasTitle() {
        ...
        XCTAssertNotEqual(sut.title, localizedKey, "Missing localized string")
    ...
    func test_loadingFeedIndicator_isVisibleWhenLoadingFeed() {
        ...
        sut.simulateAppearance()
        XCTAssertFalse(sut.isShowingLoadingIndicator, "Expected no loading indicator if view is appearing is called again")
    }
    ...
    func test_feedImageView_loadsURLWhenVisible() {
        ...
        XCTAssertEqual(loader.loadedImageURLs, [], "Expected no loaded image URLs until views become visible")
        
        sut.simulateFeedImageViewVisible(at: 0)
        XCTAssertEqual(loader.loadedImageURLs, [image0.url], "Expected first image URL once first view becomes visible")
        
        sut.simulateFeedImageViewVisible(at: 1)
        XCTAssertEqual(loader.loadedImageURLs, [image0.url, image1.url], "Expected second image URL once second view also becomes visible")
    }
    ...
    func test_feedImageView_cancelsImageLoadingWhenNotVisibleAnymore() {
        ...
        XCTAssertEqual(loader.canceledImageURLs, [], "Expected no canceled image URLs until image becomes not visible")
        
        sut.simulateFeedImageViewNotVisible(at: 0)
        XCTAssertEqual(loader.canceledImageURLs, [image0.url], "Expected one canceled URL request once first view is no longer visible")
        
        sut.simulateFeedImageViewNotVisible(at: 1)
        XCTAssertEqual(loader.canceledImageURLs, [image0.url, image1.url], "Expected two canceled URL requests once second view also is no longer visible")
    }
